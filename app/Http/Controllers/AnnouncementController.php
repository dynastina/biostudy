...
class AnnouncementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menambahkan ' . self::$pageTitle . ' baru dengan judul '. $req['name'],
    ...
    public function update(Request $request, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' mengubah ' . self::$pageTitle . ' dengan judul '. $req['name'],
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function destroy(Request $req, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menghapus ' . self::$pageTitle . ' dengan judul '. $announcement['name'],
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
