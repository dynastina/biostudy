...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('front-end/build') }}/style.css">
    <!-- endinject -->
...
<body>
                    ...
                    <div class="menu_area menu8">
                        <div class="container">
                            <nav class="navbar navbar-expand-lg navbar-light px-0 ">
                                <a class="navbar-brand order-sm-1 order-1" href="#"><img src="{{ asset('front-end/build') }}/img/logo.png" alt="" /></a>
                                        ...
                                        <div class="cart__items shadow-lg-2">
                                            <div class="items">
                                                <div class="item_thumb">
                                                    <img src="{{ asset('front-end/build') }}/img/ci1.jpg" alt="hukka miyan">
                                                </div>
                                                <div class="item_info">
                                            ...
                                            <div class="items">
                                                <div class="item_thumb">
                                                    <img src="{{ asset('front-end/build') }}/img/ci2.jpg" alt="hukka miyan">
                                                </div>
                                                <div class="item_info">
                                                    <a href="single-product.html">Business Marketing Presentation</a>
                ...
                <div class="col-lg-12">
                    <div class="logo-carousel-four owl-carousel">
                        <div class="carousel-single">
                            <img src="{{ asset('front-end/build') }}/img/cl14.png" alt="">
                        </div><!-- ends: .carousel-single -->
                        <div class="carousel-single">
                            <img src="{{ asset('front-end/build') }}/img/cl15.png" alt="">
                        </div><!-- ends: .carousel-single -->
                        <div class="carousel-single">
                            <img src="{{ asset('front-end/build') }}/img/cl16.png" alt="">
                        </div><!-- ends: .carousel-single -->
                        <div class="carousel-single">
                            <img src="{{ asset('front-end/build') }}/img/cl17.png" alt="">
                        </div><!-- ends: .carousel-single -->
                        <div class="carousel-single">
                            <img src="{{ asset('front-end/build') }}/img/cl18.png" alt="">
                        </div><!-- ends: .carousel-single -->
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="testimonial-carousel-six owl-carousel">
                        <div class="carousel-single">
                            <img src="{{ asset('front-end/build') }}/img/client6.jpg" alt="" class="rounded-circle">
    ...
    <script src="{{ asset('front-end/build') }}/vendor_assets/js/revolution/jquery.themepunch.revolution.min.js"></script>
    <script src="{{ asset('front-end/build') }}/vendor_assets/js/revolution/extensions/revolution.extension.actions.min.js"></script>
    <script src="{{ asset('front-end/build') }}/vendor_assets/js/revolution/extensions/revolution.extension.carousel.min.js"></script>
    <script src="{{ asset('front-end/build') }}/vendor_assets/js/revolution/extensions/revolution.extension.kenburn.min.js"></script>
    <script src="{{ asset('front-end/build') }}/vendor_assets/js/revolution/extensions/revolution.extension.layeranimation.min.js"></script>
    <script src="{{ asset('front-end/build') }}/vendor_assets/js/revolution/extensions/revolution.extension.migration.min.js"></script>
    <script src="{{ asset('front-end/build') }}/vendor_assets/js/revolution/extensions/revolution.extension.navigation.min.js"></script>
    <script src="{{ asset('front-end/build') }}/vendor_assets/js/revolution/extensions/revolution.extension.parallax.min.js"></script>
    <script src="{{ asset('front-end/build') }}/vendor_assets/js/revolution/extensions/revolution.extension.slideanims.min.js"></script>
    <script src="{{ asset('front-end/build') }}/vendor_assets/js/revolution/extensions/revolution.extension.video.min.js"></script>
