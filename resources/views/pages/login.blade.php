...
<div class="card rounded-3 w-md-550px">
    ...
    <div class="card-body p-10 p-lg-20">
        <!--begin::Theme mode-->
        <div class="app-navbar-item ms-1 ms-lg-3 d-flex justify-content-center mb-5">
            <!--begin::Menu toggle-->
        ...
        <form method="POST" class="form" id="kt_login_singin_form" action="{{ route('login.post') }}">
            ...
            <!--end::Alert-->
            @endif
            @if ($message = Session::get('non-active'))
            <!--begin::Alert-->
            <div class="alert alert-danger d-flex align-items-center p-5">
                <!--begin::Icon-->
                <span class="svg-icon svg-icon-2hx svg-icon-danger me-3">
                ...
                <div class="d-flex flex-column">
                    ...
                    <!--end::Title-->
                    <!--begin::Content-->
                    <span>Akun telah di nonaktifkan</span>
                    <!--end::Content-->
                </div>
                <!--end::Wrapper-->
            </div>
            ...
            <div class="alert alert-success d-flex align-items-center p-5">
                ...
                <div class="d-flex flex-column">
                    <!--begin::Title-->
                    <h4 class="mb-1 text-dark">Logout Berhasil!</h4>
                    <!--end::Title-->
                    <!--begin::Content-->
                    <span>Terimakasih, sampai jumpa kembali</span>
                    <!--end::Content-->
                </div>
                <!--end::Wrapper-->
            </div>
