				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder text-gray-900 mb-5">Request berhasil dikirim</h1>
							<!--end::Title-->
							<!--begin::Message-->
							<div class="fs-6 fw-semibold text-gray-500 mb-10">Silahkan tunggu sampai admin menghubungi anda 
							<br />dan mendaftarkan akun untuk anda</div>
							<!--end::Message-->
							<!--begin::Link-->
							<div class="mb-11">
								<a href="{{ url('application') }}" class="btn btn-sm btn-primary">Home</a>
							</div>
							<!--end::Link-->
							<!--begin::Illustration-->
							<div class="mb-0">
