                                ...
                                <tr>
                                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                                        ...
                                        <div style="text-align:center; margin:0 15px 34px 15px">
                                            ...
                                            <!--end:Text-->
                                            <!--begin:Action-->
                                            <a href='{{ route('login.forgot-password-process') }}?e={{ $req['encrypted_email'] }}&u={{ $req['username'] }}' target="_blank" style="background-color:#50cd89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500;">Activate Account</a>
                                            <!--begin:Action-->
                                        </div>
                                        <!--end:Email content-->
                                    </td>
