                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-center flex-column py-5">
                            ...
                            <div class="symbol symbol-100px symbol-circle mb-7">
                                <img src="{{ asset('metronic/dist') }}/assets/media/avatars/300-6.jpg" alt="image" />
                            ...
                            <!--end::Avatar-->
                            <!--begin::Name-->
                            <a class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{ $user->name }} <!--begin::Svg Icon | path: icons/duotune/general/gen026.svg-->
                            ...
                            <div class="d-flex flex-stack">
                                <div class="d-flex">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="#" class="fs-5 text-dark text-hover-primary fw-bold">Google Mail (GMAIL)</a>
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                                        <!--begin::Input-->
                                        <input class="form-check-input" name="google" type="checkbox" value="1" id="kt_modal_connected_accounts_google" checked="checked" disabled />
                                        <!--end::Input-->
                                        <!--begin::Label-->
                                ...
                                <div class="card-title flex-column">
                                    ...
                                    <div id="kt_user_view_details" class="collapse show">
                                        <div class="pb-5 fs-6">
                                            ...
                                            <div class="text-gray-600">{{ $user->birth_date ?? '-'}}</div>
